...
subscription_id = "23a55e7d-3087-4f78-8e49-03977b64e475"
resource_group = "rg-rag-project-dev"
aoai_deployment_name = "gpt-4"
aoai_connection_name = "aoai-connection"
project_name = "ai-project-rrbmbrnaodaxw"  # Ex: ai-project-lh7b37cbhixdq
endpoint_name = "rag-0102-endpoint"  # Ex: rag-PCLN-endpoint
deployment_name = "rag-0102-deployment"  # Ex: rag-PCLN-deployment
...
trigger_schedule = CronTrigger(expression="*/1 * * * *")
